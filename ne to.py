...
pygame.display.set_caption("Уровень игры")

WHITE = (255, 255, 255)
BLACK = (0, 0, 0)

background = pygame.image.load(os.path.join("data", "background", "hall.jpg"))
...
platform_image = pygame.image.load(os.path.join("data", "plat_unfon.png")).convert_alpha()
platform_image = pygame.transform.scale(platform_image, (200, 100))  # Масштабируем платформу
platform_image.set_colorkey((255, 255, 255))

platforms = [
    {"rect": pygame.Rect(0, HEIGHT - 50, WIDTH * 2, 50), "image": None},  # Основная платформа (без изображения)
    {"rect": pygame.Rect(300, 400, 200, 20), "image": platform_image},
    {"rect": pygame.Rect(600, 300, 150, 20), "image": platform_image},
    {"rect": pygame.Rect(1000, 200, 200, 20), "image": platform_image},
]
...
platform_image = pygame.transform.scale(platform_image, (200, 60))  # Масштабируем платформу
platform_image.set_colorkey((255, 255, 255))

platforms = [
    {"rect": pygame.Rect(0, HEIGHT - 50, WIDTH * 4, 50), "image": None},  # Основная платформа (без изображения)
    {"rect": pygame.Rect(300, 400, 200, 20), "image": platform_image},
...
# БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ БЕЗ АТАКИ
